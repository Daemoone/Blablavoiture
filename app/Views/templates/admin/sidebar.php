<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
    <div class="sidebar-header border-bottom">
        <div class="sidebar-brand">
            <a href="<?= base_url('/admin'); ?>"><img src="<?= base_url('/assets/brand/logo-voiture.svg'); ?>" class="sidebar-brand-full" _width="88"
            height="32"
            alt="Mon Projet" /></a>
            <a href="<?= base_url('/admin'); ?>"><img src="<?= base_url('/assets/brand/logo-voiture.svg'); ?>" class="sidebar-brand-narrow" _width="32"
                 height="32"
                 alt="Mon Projet" /></a>
            Blabla-voiture
        </div>
