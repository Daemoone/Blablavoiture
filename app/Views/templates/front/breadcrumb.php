        ...
        <ul class="header-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="/user/">Modifier mon compte</a></li>
            ...
            <?php } else { ?>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="nav-item dropdown" href="/login/register">
                                <div class="btn btn-primary align-center mb-3"> S'inscrire </div>
                            </a>
                        </li>
                        <li>
                            <a href="/login">
