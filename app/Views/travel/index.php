            ...
            <form action="<?= base_url('travel/createtravel'); ?>" method="POST">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="city_departure" class="form-select" name="id_city_departure" required></select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="city_arrival" class="form-select" name="id_city_arrival" required></select>
                    </div>
